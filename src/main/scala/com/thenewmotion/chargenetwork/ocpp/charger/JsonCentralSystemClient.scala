...
class JsonCentralSystemClient(chargerId: String, centralSystemUri: URI, aesEncryption: Boolean) extends CentralSystem with LazyLogging {

  val client = new OcppJsonClient(chargerId, centralSystemUri, aesEncryption) {
